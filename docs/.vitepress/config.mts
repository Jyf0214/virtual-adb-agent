      ...
      '/usage/automation/': [
        {
          text: '自动化集成',
          items: [
            { text: '概览', link: '/usage/automation/' },
            { text: 'MAA', link: '/usage/automation/maa' },
            { text: 'Airtest', link: '/usage/automation/airtest' },
            { text: 'Appium', link: '/usage/automation/appium' },
            { text: 'uiautomator2', link: '/usage/automation/uiautomator2' },
          ],
        },
      ],
      '/legal/': [
